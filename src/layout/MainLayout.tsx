...
export function Layout() {
  ...
  const links = [
    ...
    { name: "⚙️ Settings", to: "/app/settings" },
  ];
...
export function AdminLayout() {
  ...
  const links = [
    ...
    { name: "📈 AI Usage", to: "/admin/ai-usage" },
    { name: "💳 Subscriptions", to: "/admin/subscriptions" },
    { name: "✉️ Newsletter", to: "/admin/newsletter" },
    { name: "📝 Content", to: "/admin/content" },
    { name: "⚙️ Settings", to: "/admin/settings" },
  ];
